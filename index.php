...
<head>
    ...
    <meta name="description" content=" reseña de peliculas y ver trailers y más en cineTecc.">
    <meta name="keywords" content="películas, cine, estrenos, películas de acción, cineTecc">
...
<script>
    ...
    <footer class="footer container">
        ...
        <ul>
            <li><a href="#">Inicio</a></li>
            <li><a href="https://www.facebook.com/kxrmaeubloodformercy/" target="_blank" rel="noopener noreferrer">Nosotros</a></li>

            <li><a href="#">Peliculas</a></li>
            <li><a href="#">Contactos</a></li>
        </ul>
        <p>Copyright © 2024 - cinemeTec. 
            Este es el mejor catálogo de medios de entretenimiento que cubre películas. No pierdas tu tiempo libre y relájate con cinemeTec.</p>
    </footer>
    ...
    <script>
        function myFunction() {
            window.location.href = "http://localhost/paginapelis";
